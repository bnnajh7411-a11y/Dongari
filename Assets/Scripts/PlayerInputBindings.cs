...
public static class PlayerInputBindings
{
    ...
    {
        { InputActionType.MoveUp, "Move Up" },
        { InputActionType.MoveDown, "Move Down" },
        { InputActionType.MoveLeft, "Move Left" },
        { InputActionType.MoveRight, "Move Right" },
        { InputActionType.Run, "Run" },
